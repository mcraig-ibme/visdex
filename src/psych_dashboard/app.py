...
all_components = dict(scatter=[{'component_type': dcc.Dropdown,
                                'id': 'x',
                                'label': 'x',
                                'value': None,
                                'multi': False,
                      ...
                      bar=[{'component_type': dcc.Dropdown,
                            'id': 'x',
                            'label': 'x',
                            'value': None,
                            'options': [],
                      ...
                      manhattan=[{'component_type': dcc.Dropdown,
                                  'id': 'base_variable',
                                  'label': 'base variable',
                                  'value': None,
                                  'options': [],
                      ...
                      violin=[{'component_type': dcc.Dropdown,
                               'id': 'base_variable',
                               'label': 'base variable',
                               'value': None,
                               'options': [],
                      ...
                      histogram=[{'component_type': dcc.Dropdown,
                                  'id': 'base_variable',
                                  'label': 'base variable',
                                  'value': None,
                                  'options': [],
